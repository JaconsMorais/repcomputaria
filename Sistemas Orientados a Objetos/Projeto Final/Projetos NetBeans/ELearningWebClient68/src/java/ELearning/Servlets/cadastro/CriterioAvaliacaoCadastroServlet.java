 ...
 * @author Acessa SP
 */
@WebServlet(name = "CriterioAvaliacaoCadastroServlet", urlPatterns = {"/CriterioAvaliacaoCadastro"})
public class CriterioAvaliacaoCadastroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CriterioAvaliacaoCadastroServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CriterioAvaliacaoCadastroServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
            CriterioAvaliacao criterio = new CriterioAvaliacao();
            criterio.setNome((String)request.getParameter("nomeCriterio"));
            criterio.setIdDisciplina(Long.parseLong((String)request.getParameter("idDisciplinaCriterio")));
            ...
            if(port.cadastrarCriterio(criterio)){
