 ...
 * @author Acessa SP
 */
@WebServlet(name = "CriterioAvaliacaoExclusaoServlet", urlPatterns = {"/CriterioAvaliacaoExclusao"})
public class CriterioAvaliacaoExclusaoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            criterio.setIdCriterioAvaliacao(Long.parseLong((String)request.getParameter("idCriterioExclusao")));
            ...
            if(port.deletarCriterio(criterio)){
