 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://services.ELearning/", wsdlLocation = "http://localhost:9960/ELearningServices/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICE_QNAME = new QName("http://services.ELearning/", "ReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9960/ELearningServices/ReportService?wsdl");
    ...
    public ReportService getReportServicePort() {
        return super.getPort(new QName("http://services.ELearning/", "ReportServicePort"), ReportService.class);
    }
    ...
    public ReportService getReportServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ELearning/", "ReportServicePort"), ReportService.class, features);
    }
