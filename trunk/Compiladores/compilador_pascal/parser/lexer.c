...
/* skipall: ignora espaÃ§os em branco e comentÃ¡rios */
void
skipall (FILE * tape)
{
  char head;
...
/*gettoken: verifica a situação do token atual e, se for token,
 *pega o token*/
token_t
...
/*match: verifica se o token "bate" de acordo com o que se esperava
*pela gramática*/
void
