 ...
 * @author Acessa SP
 */
@WebServlet(name = "NotaExclusaoServlet", urlPatterns = {"/NotaExclusao"})
public class NotaExclusaoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             ...
             */
            Nota nota = new Nota();
            nota.setIdNota(Long.parseLong((String)request.getParameter("idNotaExclusao")));
            NotaService_Service service = new NotaService_Service();
            NotaService port = service.getNotaServicePort();

            if(port.deletarNota(nota)){
